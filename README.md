...
I build Python backends — REST APIs, authentication systems, and ML-powered applications.

🔭 Currently seeking **Junior Python Backend Developer** roles.

🚀 Recently built a production-grade Task Manager API using FastAPI, SQLAlchemy, JWT auth, 
pytest testing, and deployed on Render.

🛠️ Built a Course Recommender processing 180,000+ records using Flask + ML (content-based 
+ collaborative filtering).

🔬 Contributed to a behavioural biometrics research project — keystroke audio analysis 
for user identification across 100+ students.
